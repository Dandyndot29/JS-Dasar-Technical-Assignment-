...
/// EDIT HERE
if (userAge === 0 ) {
    console.console.log('Anda belum cukup umur');
} else if (userAge === 18 ) {
        console.log('Selamat berkendara');
  }  else { 
      console.log('Diharapkan untuk membuat SIM terlebih dahulu'); }

///Akan menampilkan pesan "Selamat Berkendara" apabila userAge = 18 dan drivingLicense = true
...
///Akan menampilkan "212" apabila temperature = 100 dan unit = "F"
